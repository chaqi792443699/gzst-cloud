...
/**
 * zuul网关配置刷新 https://my.oschina.net/u/2948566/blog/1592370 文档
 */
...
//    }
    ...
    private Map<String, ZuulProperties.ZuulRoute> locateRoutesFromDB() {
        ...
        List<ZuulRoute> results = jdbcTemplate.query("select * from gateway_zuul_route where enabled = true ", new
                BeanPropertyRowMapper<>(ZuulRoute.class));
