...
import cn.gov.gzst.oss.common.config.AliyunConfig;
...
public class AliyunOSSClient extends  AbstractOSSClient {
    ...
    public void init(String propertiesName) {
        ...
        accessKeyId = p.getString("aliyun.oss.access_key_id");
        accessKeySecret = p.getString("aliyun.oss.access_key_secret");
        bucketName = p.getString("aliyun.oss.bucket_name");
