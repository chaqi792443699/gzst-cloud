...
SERVER_NAME='cloud-sso-server'
JAR_NAME='cloud-sso-server-1.0.0-SNAPSHOT.jar'
cd `dirname $0`
BIN_DIR=`pwd`
cd ..
DEPLOY_DIR=`pwd`
...
CONFIG_FILES=" -Dlogging.path=$LOGS_DIR -Dspring.config.location=$CONF_DIR/bootstrap.yml "
