package cn.gov.gzst.common.handler;

import cn.gov.gzst.common.common.constant.DataBaseConstant;
import cn.gov.gzst.common.common.constant.DataBaseFieldConstant;
...
public class BaseMetaObjectHandler extends MetaObjectHandler {
	...
	public void insertFill(MetaObject metaObject) {
		...
		if (createBy == null&&ServletUtils.getRequest()!=null&&ServletUtils.getRequest().getHeader("uid")!=null) {
			String uid = String.valueOf(ServletUtils.getRequest().getHeader("uid"));
			if (!StringUtils.isEmpty(uid)) {
				setFieldValByName(DataBaseFieldConstant.CREATE_BY, uid, metaObject);
			}
		}
	...
	public void updateFill(MetaObject metaObject) {
		...
		if (updateBy == null&&ServletUtils.getRequest()!=null&&ServletUtils.getRequest().getHeader("uid")!=null) {
			String uid = String.valueOf(ServletUtils.getRequest().getHeader("uid"));
			if (!StringUtils.isEmpty(uid)){
				setFieldValByName(DataBaseFieldConstant.UPDATE_BY, uid, metaObject);
			}
		}
