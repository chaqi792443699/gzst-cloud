package cn.gov.gzst.common.common.service.impl;
...
import cn.gov.gzst.common.query.data.PageImpl;
import cn.gov.gzst.common.query.data.Pageable;
import cn.gov.gzst.common.query.data.Queryable;
import cn.gov.gzst.common.query.parse.QueryToWrapper;
...
public class CommonServiceImpl<M extends BaseMapper<T>, T> extends ServiceImpl<M, T> implements ICommonService<T> {
	...
	public Page<T> list(Queryable queryable, Wrapper<T> wrapper) {
		...
		return new PageImpl<T>(content.getRecords(), queryable.getPageable(), page.getTotal());
	}
