...
public interface IPactProjectbaseService extends ICommonService<PactProjectbase> {
    ...
    Page<Map<String,Object>> selectProject(@Param("page")Page<Map<String,Object>> page,@Param("ew") Wrapper<PactProjectbase> wrapper);
    List<Map<String,Object>> selectStatus();

    Page<Map<String,Object>> contractByUser(@Param("page")Page<Map<String,Object>> page,@Param("ew")Wrapper<PactProjectbase> wrapper);
