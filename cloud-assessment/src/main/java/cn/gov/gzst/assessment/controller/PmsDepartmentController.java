...
public class PmsDepartmentController extends BaseBeanController<PmsDepartment> {
    ...
    @Autowired
    private PmsDepartmentFeign pmsDepartmentFeign;
    ...
    */
    ...
    public void getDeptList(){
        ...
        PropertyPreFilterable propertyPreFilterable=new QueryPropertyPreFilter("id,name,departmentcode,enterpriseid,leader");
        SerializeFilter filter = propertyPreFilterable.constructFilter(entityClass);
