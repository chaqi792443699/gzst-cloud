...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                ...
                .apis(RequestHandlerSelectors.basePackage("cn.gov.gzst.email.controller")).paths(PathSelectors.any())
                .build();
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("科技创新云-邮件管理平台").description("科技创新云平台邮件管理平台接口说明")
