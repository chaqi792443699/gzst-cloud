...
//        mapper.setDateFormat(new EasyDateFormat(dateFormat));
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                ...
                .apis(RequestHandlerSelectors.basePackage("cn.gov.gzst.admin.controller")).paths(PathSelectors.any())
                .build();
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("科技创新云-管理平台").description("科技创新云管理平台接口说明")
