package cn.gov.gzst.admin.common.bean;
...
public class ResponseError extends cn.gov.gzst.common.bean.ResponseError {
    ...
    public static final int USER_REGISTER_PHONE_REPEAT=300012;//手机号码重复

    public static final int USER_INFO_NO_FOUND = 300013;//用户信息未发现

    public static final int TECHNICAL_DEMAND_SUBMIT_FAIL=300014;//需求提交失败

    public static final int TECHNICAL_DEMAND_AUDIT_FAIL=300015;//需求审核失败

    public static final int BIND_USER_FAIL=300016;//绑定用户失败
}
