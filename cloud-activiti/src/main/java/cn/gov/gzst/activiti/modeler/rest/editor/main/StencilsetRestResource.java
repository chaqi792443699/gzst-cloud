 ...
 */
package cn.gov.gzst.activiti.modeler.rest.editor.main;
...
public class StencilsetRestResource {
  ...
  public @ResponseBody String getStencilset() {
    ...
    InputStream stencilsetStream = this.getClass().getClassLoader().getResourceAsStream("activiti/modeler/stencilset_zh_CN.json");
